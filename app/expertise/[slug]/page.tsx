...
const servicePageContent = {
  ...
  'forensic-investigations-and-intelligence': {
    ...
    paragraphs: [
      ...
      'In practice: A membership body facing public allegations of governance failure engaged ParametricGC to advise its board through the period between the allegations surfacing and the completion of the independent review. Our strategic counsel covered stakeholder communication, regulatory engagement, interim governance measures, and the sequencing of public disclosures, ensuring the organisation maintained credibility throughout a period of sustained scrutiny.',
    ],
  },
} as const
