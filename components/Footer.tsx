        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-16">
          ...
          <div>
            ...
            <ul className="flex flex-col gap-4 text-sm uppercase tracking-wider">
              ...
              <li><Link href="/people" className="text-white hover:text-white transition-colors">Our Team</Link></li>
              <li><Link href="/news" className="text-white hover:text-white transition-colors">News & Briefings</Link></li>
              <li><Link href="/podcast" className="text-white hover:text-white transition-colors">Podcast</Link></li>
          ...
          {/* Services */}
          <div>
            <h4 className="small-title text-white mb-5">Our Services</h4>
            <ul className="flex flex-col gap-4 text-sm uppercase tracking-wider">
              {services.filter((s) => !['reputation-management-and-crisis-response', 'fintech-and-digital-assets-advisory', 'civil-fraud', 'private-client-advisory'].includes(s.slug)).map((s, index) => (
                <li key={s.slug}>
                  <Link href={`/expertise/${s.slug}`} className="text-white hover:text-white transition-colors">{index === 0 ? 'Investigations' : index === 1 ? 'Intelligence' : index === 2 ? 'Governance' : index === 3 ? 'Strategic Advisory' : s.title}</Link>
                </li>
              ))}
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a href="#" className="text-white transition-colors hover:text-white" aria-label="Instagram">
              ...
              <a href="#" className="text-white transition-colors hover:text-white" aria-label="X">
              ...
              <a href="#" className="text-white transition-colors hover:text-white" aria-label="Facebook">
